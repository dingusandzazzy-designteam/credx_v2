  ...
  if (signupForm) {
    ...
    if (step1Btn && step1) {
      step1Btn.addEventListener('click', () => {
        ...
        if (reward) {
          reward.textContent = 'You are in. Across a channel of 1,000 merchants, CredX could put up to $30M a year back in your merchants’ pockets. Two more questions and we will model your channel.';
          reward.hidden = false;
        }
