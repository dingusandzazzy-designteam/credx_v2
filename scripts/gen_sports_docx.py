...
para('For Pro Teams, Stadiums & Leagues · DRAFT — client-review edits folded in (2026-07-13)', italic=True)

h('Page metadata')
field('Title', 'CredX for Teams & Venues — Keep the Loyalty Your Fans Give You')
field('Meta description', "Your fans are the most loyal customers on earth. Keep the data, the loyalty, and the value their spending creates — in your team's brand, not a legacy credit network's. CredX is the embedded value platform for teams, stadiums, and leagues.")

h('1. Hero — The Movement')
field('Eyebrow', 'For Pro Teams, Stadiums & Leagues')
field('Headline', 'Keep the Loyalty Your Fans Already Give You')
...
field('Headline', 'The team that understands the data understands the fan.')
field('Body', 'Right now your payment processor runs the transaction, and the legacy credit network keeps everything that comes after: who your fan is, what they spend, and when they will come back. CredX puts that back in your hands. Your credit facility, your brand, your fans.')
doc.add_paragraph()
bold_line('Three Voices, One Direction')
bold_line('The Team')
para('“Your fans were already loyal. A legacy credit network was the only one profiting from it.”', italic=True)
...
field('Your fan', "The relationship stays in your team's name, not a legacy credit network's. The fan who bought season tickets and three jerseys belongs to you.")
...
field('Keep the loyalty', "A closed-loop value-back program in your team's own currency, where $1 spent is $1 earned, that keeps your fans spending with the team, not with a legacy credit network's program.")
...
field('1. Recover up to 85% of interchange', '$6,000 per $1M with CredX, against roughly $36,000 with legacy credit networks. On a $60,000 night at the gate, that is most of it staying with your team.')
...
field('Yours', "the fan, the data, and the loyalty. Not a legacy credit network's.")
...
field('Caption', 'Designed to recover up to 85% of standard interchange. Your number depends on card mix. Based on roughly $36K interchange per $1M with legacy credit networks, against $6K per $1M with CredX.')
...
field('Step 4 — Fans get branded credit and value-back', "Revolving credit of up to $5,000, issued in your team's own brand and approved in about 20 seconds at the gate, with value-back accruing in your team's own currency at $1 for every $1 spent. The relationship stays yours.")
...
field('Headline', 'Ready to keep your fans?')
...
bullet('In one line: what would keeping your fan data change for your organization?')
...
doc.add_page_break()
h('Open questions for CredX — still pending')
para('For Kyle / Kendall / Audrey. These are the copy claims still awaiting confirmation before public launch; the items resolved in the 2026-07-13 review round are already folded into the copy above. Answer directly under each item.', italic=True)
open_qs = [
